...
/*! Retorna a turma do estudante numa UC
 * O(log(n))
 */
...
/*! Retorna o ano do estudante. O ano é determinado pela UC de ano superior */
...
/*! Atribui uma nova UC ao estudante
 * O(log(n))
 */
...
/*! Altera a turma do estudante na UC para a turma nova
 * O(log(n))
 */
...
/*! Verifica se o estudante está incrito numa UC
 * 0(log(n))
 */
